...
//////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////
// In this section, attempting to integrate some typescript //
// code that Harry wrote (from Python code that Rob wrote.) //
// Nathan imagines this moving to a different, separate API //
// but this is a convenient place for it now.               //
//////////////////////////////////////////////////////////////
...
// This is just a test function/route.
// We are trying to show the ability to atom matching.
// It will have to be generalized later.
export async function testMatching(
  ...
  context.log(`Http function processed request for url "${request.url}"`);
    ...
    const okh0 = getOKHByFileName("microscope","okh","yml");

    const okhs = [okh0];

    const okw0 = getOKHByFileName("microscope","okw","yml");
    const okws = [okw0];
    const USE_REAL_MATCHING = false;

         if (USE_REAL_MATCHING) {
             ...
             const scoredList = {"a" : "357","b" : "789"};
             return { jsonBody: scoredList};
         }
}
