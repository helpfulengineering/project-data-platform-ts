...
const mockOKHData = [
  {
    id: 1,
    name: "N95 Respirator",
    description: "Medical-grade respiratory protection against airborne particles",
  ...
  },
  {
    id: 2,
    name: "Ventilator",
    description: "Medical device for assisting or replacing breathing function",
  ...
  },
  {
    id: 3,
    name: "Pulse Oximeter",
    description: "Non-invasive device measuring oxygen saturation in the blood",
  ...
  },
  {
    id: 4,
    name: "Face Shield",
    description: "Protective equipment covering the entire face from splashes and sprays",
  ...
  },
  {
    id: 5,
    name: "Hand Sanitizer",
    description: "Alcohol-based hand rub for disinfection",
...
const sendToSupplyGraphAI = async (okhItem) => {
  ...
  try {
    ...
    const payload = {
      ...
      metadata: {
        name: okhItem.name,
        description: okhItem.description,
      ...
      <div class="p-4 bg-white rounded shadow mb-4">
        <div class="flex flex-col">
          ...
          <div class="bg-blue-100 p-4 rounded mb-4 border border-blue-300">
            ...
            <p class="text-sm text-gray-600">{{ supplyTreeData.rootItem.description }}</p>
          </div>
